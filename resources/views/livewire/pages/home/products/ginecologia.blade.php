...
#[Title('Ginecología - VissionClinic')]
class extends Component {
    //
}; ?>

<x-slot:meta_description>
    Vission Clinic ECE para ginecólogos.
</x-slot>
...
<main>
    <div class="bg-[#0144E8] py-8 xl:py-0 xl:h-80 flex flex-col justify-center items-center gap-3">
        <h1 class="text-3xl xl:text-6xl text-white uppercase">Ginecología</h1>
    </div>
    ...
    <div>
        <div class="grid grid-cols-1">
            <div class="w-full md:h-[25rem] bg-red-500 col-start-1 col-end-2 row-start-1 row-end-2">
                <img class="h-full w-full object-cover object-[center]"
                    src="{{asset('images/product-ginecologia.jpeg')}}" alt="Banner Inicio Imagen">
            </div>
        ...
        <div class="px-8 md:px-20 py-20">
            ...
            <div class="space-y-5 mb-10">
                <p>
                    Con nuestro software de salud Vission Clinic ECE para ginecólogos tendrás la versatilidad que
                    requiere
                    para
                    consultar la información de tu consultorio desde cualquier lugar y en cualquier dispositivo
                    electrónico,
