    ...
    <form wire:submit='save' class="mt-5">
        ...
        <fieldset class="mt-10">
            ...
            <section class="flex justify-end">
                <p>LLene los signos vitales en la sección de <a href="{{route('dashboard.expedientes.medicalConsultation', ['id' => $patient->id])}}" class="text-blue-500 border-b border-blue-500">consulta médica</a></p>
            </section>
            @endif
