...
new class extends Component {
    ...
    public function save()
    {
        $validated = $this->validate([
            'exanthematicDiseases' => 'array',
            'exanthematicDiseases.*' => 'array',
            'exanthematicDiseases.*.applies' => 'boolean',
            'chronicDegenerativeDiseases' => 'array',
            'chronicDegenerativeDiseases.*' => 'array',
            'chronicDegenerativeDiseases.*.applies' => 'boolean',
        ]);

        $pathologicalHistory = PathologicalHistory::updateOrCreate(
            ['medical_record_sections_id' => $this->sectionId],
            [
                'medical_record_sections_id' => $this->sectionId,
                'exanthematic_diseases' => json_encode($this->exanthematicDiseases),
                'chronic_degenerative_diseases' => json_encode($this->chronicDegenerativeDiseases),
                'other_diseases' => json_encode($this->otherDiseases),
                'created_at' => now(),
                'updated_at' => now(),
            ]
        );
